...
def main():
    ...
    <h3><b><i class="fa fa-dashboard"></i>   """)
	print(city)	
	print("""
	<head>
    ...
    <body>
    <center><div id="chart_div" class ="chart_div" style="width: 1500px; height: 500px;"></div></center>
	<p> <center> The average concentration of PM 2.5 over the next 24 hours is: """)
	print(avg)
	print(""" ug/m^3. The corresponding AQI with this value is: </center> </p> <center>""")
	if avg <= 30.00:
		print("good")
